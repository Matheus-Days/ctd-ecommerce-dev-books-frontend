    ...
    <>
      <div id="profile">
        <div className="profile-intro">
          ...
          <p className="profile-txt">Somos alunos do 3º bimestre do Curso de Programação Certified Tech Developer, pensado e desenhado pelo Mercado Livre, Globant e a Digital House.  Obrigado pela visita!</p>
        </div>
